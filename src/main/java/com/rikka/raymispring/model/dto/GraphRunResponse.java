...
public class GraphRunResponse {
	...
	public GraphRunResponse(String node, String eventType, String agent, Message message, Usage tokenUsage, String chunk,
	...
	public GraphRunResponse(String node, String eventType, String agent, MessageDTO message, Usage tokenUsage, String chunk,
			Map<String, Object> state) {
		this.node = node;
		this.eventType = eventType;
		this.agent = agent;
