 ...
 */
package com.rikka.raymispring.model.dto.messages;
...
public class AgentRunResponse {
	 ...
	 */
	public AgentRunResponse(String node, String eventType, String agent, Message message, Usage tokenUsage, String chunk) {
		this.node = node;
	 ...
	 */
	public AgentRunResponse(String node, String eventType, String agent, MessageDTO message, Usage tokenUsage, String chunk) {
		this.node = node;
		this.eventType = eventType;
		this.agent = agent;
